    ...
    return (
        <div className="item pt-6 py-8 border border-x-0 border-t-0 border-b-slate-300 flex justify-between">
            ...
            <div className="item-image flex flex-col items-center gap-2 cursor-pointer">
                ...
                <button className=' w-20 px-auto py-1 font-bold text-sm text-green-500 bg-white rounded-sm border border-slate-300 shadow-md hover:shadow-lg' onClick={handleAddItem}>ADD</button>
            </div>
        </div>
    )
}