...
export default function Cart() {
    ...
    const totalPrice = Math.floor(cartItems.map(item => item.price/100).reduce((acc, value) => {
        return acc + value;
    }, 0));
    ...
    return (
        <div className="my-12 flex flex-col">
            <div className="flex justify-center items-center gap-3">
                            ...
                            <i className="fa-solid fa-cart-shopping text-2xl pt-2" style={{ 'color': '#B197FC' }}></i>
            </div>
            {
                cartItems.length == 0 ? 
                (
                    <div className="mt-6 text-xl flex flex-col items-center gap-2">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <p className="text-slate-700">Add some food and get into good mood</p>
                    ...
                    <div>
                        <div className="flex mt-8">
                            <div className="w-6/12 px-8 flex flex-col">
                                <button className="w-28 mr-1 py-2 px-3 self-end bg-green-600 font-bold text-white rounded-lg" onClick={handleClearCart}>Clear Cart</button>
                                <div className="">
                            ...
                            <div className="w-6/12 px-8 mt-16">
                                <h1 className="text-xl font-bold text-slate-800 mb-4">Bill Details</h1>
                                ...
                                <div className="px-4">
                                    <div className="flex justify-between mb-3">
                                        <p>Delivery Tip</p>
                                        <a href="#" className="text-orange-500">Add tip</a>
                                    </div>
                                    <div className="flex justify-between mb-3">
                                        <p>Platform fee</p>
